...
export default function PostWidget({ postId, postUserId, name, description, location, picturePath, userPicturePath, likes, comments }) {
    ...
    const patchLike = async () => {
        const response = await fetch(`http://192.168.0.125:3001/posts/${postId}/like`, {
            method: "PATCH",
            headers: { 
